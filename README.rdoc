...
Esse projeto tem a intenção de compartilhar o mesmo banco de dados chamado Lihead para os projetos LiHead BackOffice e LiHead Site, onde o backoffice consegue administrar os membros e os produtos do site. E integrar a aplicação <b>escamboapp</b> com um banco de dados chamado <b>escamboapp</b>.
...
* Sem o projeto LiHead Site a sessão "Members" não funcionará.
